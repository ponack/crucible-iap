...
- [ ] GitHub App integration — replace personal access tokens and webhook secrets with a first-class GitHub App; enables push events, PR comments, and commit statuses across all repos without per-repo tokens
